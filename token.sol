...
@author Hunter Long - Ingeniería BITS (Junior Calle - Rafael SantaMaría)
...
contract Token is StandardToken {
    ...
    function createTokens() internal {
        uint256 total = 800000000000000;
        balances[this] = total;
        totalSupply = total;
    }

    // function changeTransfer(bool _allowed) external {
    //     require(msg.sender == mintableAddress);
    //     allowTransfer = _allowed;
    // }
